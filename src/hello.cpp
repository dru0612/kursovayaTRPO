...
void hello()
{
    ...
    cout << "Мы здесь, чтобы скрасить ваш вечерок изучением английского языка\n\n";
    cout << "Эта программа предназначена для оттачивания ваших знаний\n"
